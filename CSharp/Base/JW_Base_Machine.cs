...
public class JW_Base_IMachine
{
    ...
    public virtual void JumpState(JW_Base_IMachine subMachine, string stateName) { }
    public virtual void OnDestroy() { }
    public virtual void Exit() { }
}

public abstract class JW_Base_Machine : JW_Base_IMachine
{
    protected Dictionary<string, JW_Base_IState> stateDict;
    protected JW_Base_IState currentState;
    protected JW_Base_IMachine subMachine;
    ...
    public override void JumpState(JW_Base_IMachine machine, string stateName)
    {
    ...
    public void AddState(string stateName, JW_Base_IState state)
    {
        if (stateDict == null)
            stateDict = new Dictionary<string, JW_Base_IState>();
